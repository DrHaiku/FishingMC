...
public class ItemBuilder {
    ...
    public ItemBuilder hideAttributes() {
        ...
        itemMeta.addItemFlags(ItemFlag.HIDE_UNBREAKABLE, ItemFlag.HIDE_POTION_EFFECTS, ItemFlag.HIDE_PLACED_ON, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_DESTROYS, ItemFlag.HIDE_ATTRIBUTES);
    ...
    public ItemBuilder setCustomModelData(int texture) {
        ItemMeta im = is.getItemMeta();
        im.setCustomModelData(texture);
        is.setItemMeta(im);
        return this;
    }
